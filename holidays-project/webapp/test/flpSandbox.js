		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Holidays Project",
									"targetURL": "#sapbtpholidaysproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpholidaysproject-display": {
								"semanticObject": "sapbtpholidaysproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.holidaysproject",
									"url": sap.ui.require.toUrl("sap/btp/holidaysproject")
								}
							}
						}
					}
